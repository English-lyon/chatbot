...
class _PlacementTestScreenState extends State<PlacementTestScreen> {
  ...
  List<_PlacementQuestion> _buildPlacementQuestions() {
    final questions = [
      ...
      _PlacementQuestion(
        question: Question(
            question: "J'aime le lait",
            answer: 'I like milk',
            options: ['I', 'like', 'milk', 'water', 'the', 'is'],
            emoji: '🧩',
            type: QuestionType.wordOrder),
        level: 'A2',
      ),
      ...
      _PlacementQuestion(
        question: Question(
            question: 'Elle aime manger des pommes',
  ...
  void _checkSelectedOption() {
    if (_answered || _selectedOptionIndex == null) return;
    final question = _questions[_currentIndex];
    final selectedAnswer = _shuffledOptions[_selectedOptionIndex!];
    final isCorrect =
  ...
  void _checkWordOrder() {
    ...
    final isCorrect =
        builtSentence.toLowerCase() == question.question.answer.toLowerCase();
  ...
  void _finishTest() {
    ...
    final allLevels =
        LearningPath.getSections().map((s) => s.cefrLevel).toList();
    String placedLevel;
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text('$_correctCount/${_questions.length} bonnes réponses',
                  style: const TextStyle(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Text('Ton niveau de départ :',
              ...
              Text(
                unitsToSkip.isEmpty
                    ? "On commence depuis le début ! \u{1F680}"
                    : "On a passé les leçons faciles pour toi ! \u{1F3AF}",
          ...
          actions: [
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('C\'est parti ! \u{1F389}',
                    style:
    ...
    switch (q.type) {
      case QuestionType.listening:
        return Column(children: [
          ...
          const SizedBox(height: 12),
          const Text('🎧 Quel mot entends-tu ?',
              style: TextStyle(
                  fontSize: 22,
              ...
              child:
                ...
                Flexible(
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            color:
                                const Color(0xFF58CC02).withValues(alpha: 0.06),
      ...
      case QuestionType.reading:
        ...
        final sentence =
            parts.length > 1 ? parts[0].replaceFirst('Read: ', '') : q.question;
          ...
          Container(
            ...
            child: Row(children: [
              const Icon(Icons.volume_up_rounded,
                  color: Color(0xFF1CB0F6), size: 22),
  ...
  Widget build(BuildContext context) {
    ...
    final isOptionType = q.question.type == QuestionType.multipleChoice ||
        q.question.type == QuestionType.listening ||
        q.question.type == QuestionType.reading ||
        q.question.type == QuestionType.fillBlank ||
        q.question.type == QuestionType.conversation;
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text('Voyons ce que tu sais, $userName ! 🔍',
                      style:
                  ...
                  if (q.question.type == QuestionType.wordOrder) ...[
                    Container(
                      ...
                      child: Wrap(spacing: 8, runSpacing: 8, children: [
                        ...
                        if (_selectedWords.isEmpty)
                          Text('Appuie sur les mots ci-dessous...',
                              style: TextStyle(
                                  fontSize: 16,
                    ...
                    if (!_answered)
                      SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed:
                                _selectedWords.isEmpty ? null : _checkWordOrder,
                            style: ElevatedButton.styleFrom(
                                backgroundColor: const Color(0xFF58CC02),
                                foregroundColor: Colors.white,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Row(children: [
                              Expanded(
                                  child: Text(_shuffledOptions[index],
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.w700,
                                          color: textCol),
    ...
    return Positioned(
      ...
      child: TweenAnimationBuilder<double>(
        ...
        builder: (context, value, child) =>
            Transform.translate(offset: Offset(0, value * 200), child: child),
        child: SafeArea(
          top: false,
          child: Container(
